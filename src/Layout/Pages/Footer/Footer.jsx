    ...
    return (
        <div className=" bg-[#abce4e] ">
            ...
            <footer className="footer p-10 max-w-7xl mx-auto text-neutral-content">
                <nav>
                    <header className="footer-title opacity-100 text-3xl text-slate-900">Newsletter</header> 
                    <p className='text-xl text-slate-900 font-medium'>
                    Signup for our newsletter to get updated information, insight, or promotions.
                    </p>
                    <Link to={'/register'} className="btn bg-[#FEBF05] border-none w-72 text-white hover:text-[#FEBF05] hover:bg-white hover:outline hover:outline-offset-0 hover:outline-[#FEBF05]"> Sign Up </Link>
                </nav> 
                <nav className='flex flex-col items-center'>
                    <header className="footer-title text-3xl text-slate-900 opacity-100">PartyBlowout</header> 
