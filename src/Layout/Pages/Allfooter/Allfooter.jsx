import copy from '../../../assets/party.png'

const Allfooter = () => {
    return (
        <div>
            <footer className="footer items-center p-4 bg-[#abce4e] text-neutral-content gap-6 justify-center">
  <aside className="items-center grid-flow-col">
    ...
    <img src={copy} alt="" className='h-20 w-20' />
    <p className='text-slate-900 text-xl font-medium'>Copyright © 2023 - All right reserved</p>
  </aside> 
