...
const Navbar = () => {
  const {user,logout}=useContext(Authcontext)
    ...
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 z-10">
        {links}
      </ul>
    </div>
    <a className="normal-case text-xl md:text-5xl font-bold">Party<span className="text-[#abce4e]">Blowout</span></a>
                    </div>
